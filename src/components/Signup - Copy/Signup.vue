...
<div class="container">
    ...
    <div class="signup_main">
        ...
        <div class="signup_left">
            ...
            <input type="text" class="lname" placeholder="Last Name" name="last_name" v-model="state.lname">
            </div>
