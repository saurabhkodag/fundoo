     ...
     <div v-for="objj in this.response" :key="objj.id"> 
         ...
         <div class="info_down">
              <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24"  width="18px" fill="grey"><path d="M10.01 21.01c0 1.1.89 1.99 1.99 1.99s1.99-.89 1.99-1.99h-3.98zM12 6c2.76 0 5 2.24 5 5v7H7v-7c0-2.76 2.24-5 5-5zm0-4.5c-.83 0-1.5.67-1.5 1.5v1.17C7.36 4.85 5 7.65 5 11v6l-2 2v1h18v-1l-2-2v-6c0-3.35-2.36-6.15-5.5-6.83V3c0-.83-.67-1.5-1.5-1.5zM13 8h-2v3H8v2h3v3h2v-3h3v-2h-3z"/></svg>
                ...
                <svg xmlns="http://www.w3.org/2000/svg"  @click="archivethis('test',objj._id)"  height="24px" viewBox="0 0 24 24"  width="18px" fill="grey"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M20.54 5.23l-1.39-1.68C18.88 3.21 18.47 3 18 3H6c-.47 0-.88.21-1.16.55L3.46 5.23C3.17 5.57 3 6.02 3 6.5V19c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6.5c0-.48-.17-.93-.46-1.27zM6.24 5h11.52l.81.97H5.44l.8-.97zM5 19V8h14v11H5zm8.45-9h-2.9v3H8l4 4 4-4h-2.55z"/></svg>
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24"  width="18px" fill="grey"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/></svg>
        </div>
        </div>
      </div>
      </div>
...
export default{
    ...
    methods:{
        ...
        // },
        archivethis(prop,val){
            this[prop]=val;
            console.log(this.test);
                //  axios.post(`http://localhost:3200/noteadd")                  ,{headers:auth:"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MTNkZGE5NDVhN2Q3ZTQ0ZjE5NTNjMTkiLCJpYXQiOjE2MzE2MjEwNDR9.VrFo4YaxeSSnDUl7xV4d-ZsXPRQdmdTgQ4rJf5PhbKc"}})
        },
        submitForm(){
        //     this.v$.$validate()
        //    let data={
