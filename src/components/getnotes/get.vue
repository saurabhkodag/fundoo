     ...
     <div> 
         ...
         <div class="info_down"  >
             <div v-if="disp"  @mouseover="this.disp=true" @mouseleave="this.disp=false" class="palette">
              <div class="one">
              <div class="p_white"  @click="changeColor('test',note_id ,'white')"></div>
              <div class="p_teal" @click="changeColor('test',note_id ,'teal')"></div>
              <div class="p_brown" @click="changeColor('test',note_id ,'brown')"></div>
              </div>
              <div class="two">
              <div class="p_red" @click="changeColor('test',note_id ,'red')"></div>
              <div class="p_blue" @click="changeColor('test',note_id ,'blue')"></div>
              <div class="p_grey" @click="changeColor('test',note_id ,'grey')"></div>
              </div>
              <div class="three">
              <div class="p_orange" @click="changeColor('test',note_id ,'orange')"></div>
              <div class="p_darkblue" @click="changeColor('test',note_id ,'darkblue')"></div>
              </div>
              <div class="four">
              <div class="p_yellow" @click="changeColor('test',note_id ,'yellow')"></div>
              <div class="p_purple" @click="changeColor('test',note_id ,'purple')"></div>
              </div>
              <div class="five">
              <div class="p_green" @click="changeColor('test',note_id ,'green')"></div>
              <div class="p_pink" @click="changeColor('test',note_id,'pink')"></div>
              </div>
            </div>
              <svg xmlns="http://www.w3.org/2000/svg"  @click="changeText('fixcolor','fixtitle','fixdescription',this.bgColor,this.content_title,this.content_main)" height="24px" viewBox="0 0 24 24"  width="18px" fill="grey"><path d="M10.01 21.01c0 1.1.89 1.99 1.99 1.99s1.99-.89 1.99-1.99h-3.98zM12 6c2.76 0 5 2.24 5 5v7H7v-7c0-2.76 2.24-5 5-5zm0-4.5c-.83 0-1.5.67-1.5 1.5v1.17C7.36 4.85 5 7.65 5 11v6l-2 2v1h18v-1l-2-2v-6c0-3.35-2.36-6.15-5.5-6.83V3c0-.83-.67-1.5-1.5-1.5zM13 8h-2v3H8v2h3v3h2v-3h3v-2h-3z"/></svg>
      ...
      <notepop v-if="this.getit" @eventname="updateparent" :colorr="this.ucolor" :titler="this.utitle" :descriptionr="this.udes" />
